...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwT8QKBscQ6ACGyR-Cxl4ogAKwV0LUUASD-I6o_Vbozqrc81jK4HIgkoMVGpbBbFzsyeQ/exec"; 
...
function tampilkanStruk(dataTransaksi, idTransaksi) {
    let htmlStruk = `<h3>Koperasi SMPN 4 Waru</h3><p>ID Transaksi: ${idTransaksi}</p><p>Waktu: ${new Date().toLocaleString('id-ID')}</p><p>Kasir: ${dataTransaksi.kasir}</p><hr>`;
    ...
    htmlStruk += `<hr><p style="text-align:center; margin-top:10px;">Terima Kasih Telah Berbelanja ^_^</p>`;
